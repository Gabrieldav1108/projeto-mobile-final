...
public class Concentracao extends AppCompatActivity {
    ImageView btnMenu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_concentracao);
        ...
        btnCalculadora.setOnClickListener(v -> {
            Intent i = new Intent(this, CalculadoraConcentracao.class);
            startActivity(i);
        });
